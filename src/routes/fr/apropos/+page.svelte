<script>
    import ProfilePicture from "../../../images/mainImage.png";
    ...
    let windowWidth, sizeBracket1=185, sizeBracket2=150;
...
<div class="flex mx-20 mt-8 gap-4 xxs:gap-1 xs:mx-5 xxs:mx-4 xxs:mt-4">
    <div class="flex-col w-1/5 xs:w-2/5">
        ...
        <div class="mt-8">
            <Buttons buttonName={"Vous voulez mon CV?"} buttonwidth={200} idName={"buttonAnchor1"}/>
        </div>
    ...
    <div class="flex-col w-4/5 mx-6 mt-10 xs:mx-0 xs:w-3/5">
        ...
        <div class="flex flex-wrap gap-8 mt-4">
            <div class="h-full flex justify-start items-center">
                ...
                <Bracket size={sizeBracket1}/>
                <div class="ml-[-25px]">
                    <h1 class="h3 text-3xl xs:text-lg xxs:text-sm">apprendre</h1>
                    <h1 class="h3 text-3xl xs:text-lg xxs:text-sm">dessiner</h1>
                    <h1 class="h3 text-3xl xs:text-lg xxs:text-sm">Math</h1>
                    <h1 class="h3 text-3xl xs:text-lg xxs:text-sm">Science</h1>
                    <h1 class="h3 text-3xl xs:text-lg xxs:text-sm">Technologie</h1>
                </div>
            </div>
            <div class="h-full flex justify-start items-center">
                <h1 class="intro text-nowrap h3 text-3xl xs:text-lg xxs:text-sm ">Je suis </h1>
                <Bracket size={sizeBracket2} skew={true} />
                <div class="ml-[-25px]">
                    <h1 class="h3 text-3xl xs:text-sm xxs:text-sm s-688:text-lg">très curieux</h1>
                    <h1 class="h3 text-3xl xs:text-sm xxs:text-sm s-688:text-lg">peu innovant</h1>
                    <h1 class="h3 text-3xl xs:text-sm xxs:text-sm s-688:text-lg">peu créatif</h1>
                    <h1 class="h3 text-3xl xs:text-sm xxs:text-sm s-688:text-sm">toujours d'apprendre</h1>
                </div>
            </div>
        </div>
    </div>
