    ...
    <div class="h-full flex flex-col justify-center items-center lg:w-2/5 xl:w-1/4 s-688:w-11/12 ">
        ...
        <div class="relative w-full h-full flex-col justify-center items-center" id="skills">
            <div class="w-full h-full flex flex-col justify-center items-center">
                ...
                <h1 class="h3 text-xl xs:text-sm xxs:text-xs">l'analyse et prétraitementdes données</h1>
                ...
                <h1 class="h3 text-xl xs:text-sm xxs:text-xs">Déploiement et intégration de modèles d'IA</h1>
